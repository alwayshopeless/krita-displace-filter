...
2. Click Tools -> Scripts -> Apply displace map
3. Select target displacement map layer
4. Configure strength param(100 by deafult)
5. Click Apply

## Install

Fast: Click Tools -> Import Plugin from file/Import file from web
